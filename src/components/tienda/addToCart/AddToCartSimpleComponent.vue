<template>
  <div class="row mt-3 d-flex align-items-center" v-if="product.has_options == false">
...
export default {
  ...
  methods: {
    ...mapMutations("cart", ["AddToCartVuex", "AddTotal", "ClearTotal"]),
